#Отличие от lazer4.py только в числе каналов и их исходный координат
...
phases = list((random()-0.5) * math.pi*2 for i in range(7))
...
x_n = (0, 4, 2, -2, -4, -2, 2)
y_n = (0, 0, -math.sqrt(3)*2, -math.sqrt(3)*2, 0, math.sqrt(3)*2, math.sqrt(3)*2)
